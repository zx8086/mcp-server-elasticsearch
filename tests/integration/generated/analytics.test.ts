/**
 * Auto-generated Integration Tests for analytics tools
...
describe.skipIf(shouldSkipIntegrationTests())("analytics Tools - Real Integration Tests", () => {
  let client: Client;
  ...
  beforeAll(async () => {
    ...
    registerGetMultiTermVectorsTool(wrappedServer, client);
