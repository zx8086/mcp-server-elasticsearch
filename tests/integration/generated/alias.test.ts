/**
 * Auto-generated Integration Tests for alias tools
 * Generated: 2025-08-20T08:05:50.545Z
 * Coverage: 5 tools
 */
...
describe.skipIf(shouldSkipIntegrationTests())("alias Tools - Real Integration Tests", () => {
  let client: Client;
  let server: McpServer;
  let wrappedServer: McpServer;
  
  // Test indices
  const TEST_INDEX = `test-alias-${Date.now()}`;
  const TEST_INDEX_PATTERN = `test-alias-*`;
