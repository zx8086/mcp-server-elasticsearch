...
import { registerAutoscalingGetPolicyTool } from "../../../src/tools/autoscaling/get_policy";
import { registerAutoscalingGetCapacityTool } from "../../../src/tools/autoscaling/get_capacity";
import { registerAutoscalingDeletePolicyTool } from "../../../src/tools/autoscaling/delete_policy";
...
describe.skipIf(shouldSkipIntegrationTests())("autoscaling Tools - Real Integration Tests", () => {
  ...
  beforeAll(async () => {
    ...
    // Register all tools
    registerAutoscalingPutPolicyTool(wrappedServer, client);
    registerAutoscalingGetPolicyTool(wrappedServer, client);
    registerAutoscalingGetCapacityTool(wrappedServer, client);
    registerAutoscalingDeletePolicyTool(wrappedServer, client);
