...
describe.skipIf(shouldSkipIntegrationTests())("bulk Tools - Real Integration Tests", () => {
  ...
  describe("Read-Only Operations", () => {
    ...
    test.skip("elasticsearch_multi_get should return valid results", async () => {
      const tool = (server as any).getTool("elasticsearch_multi_get");
    ...
    test.skip("elasticsearch_multi_get should handle missing/invalid index gracefully", async () => {
      const tool = (server as any).getTool("elasticsearch_multi_get");
    ...
    test.skip("elasticsearch_bulk_operations should return valid results", async () => {
      const tool = (server as any).getTool("elasticsearch_bulk_operations");
      expect(tool).toBeDefined();
    ...
    test.skip("elasticsearch_bulk_operations should handle missing/invalid index gracefully", async () => {
      const tool = (server as any).getTool("elasticsearch_bulk_operations");
