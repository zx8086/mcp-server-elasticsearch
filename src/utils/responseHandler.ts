...
function truncateSource(source: any, maxSourceSize: number): any {
  ...
  const importantFields = [
    ...
    "error", "exception", "error_message", "error_code",
    "status", "status_code", "response_code", "http_status",
    "name", "id", "uuid", "_id", "doc_id",
    "type", "category", "kind", "event_type",
    "user", "username", "user_id",
    "host", "hostname", "server",
    "path", "url", "uri", "endpoint",
    "method", "action", "operation",
    "duration", "response_time", "took",
