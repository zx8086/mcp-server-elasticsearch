...
import { SchemaGenerator, type ToolDocumentation } from "../src/documentation/schemaGenerator.js";
import { getAllTools } from "../src/tools/index.js";

async function generateDocumentation() {
  console.log("🔧 Generating API documentation from Zod schemas...");

  const generator = new SchemaGenerator("Elasticsearch MCP Server API", "1.0.0");
    ...
    search: [
      {
        ...
        expectedOutput: {
          hits: {
            total: { value: 100 },
            hits: [{ _index: "logs", _id: "1", _source: { message: "example log" } }],
          },
        },
      },
      {
